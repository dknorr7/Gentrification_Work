...
```
\newpage
```{r modstats2, echo=FALSE, warning=FALSE, message=FALSE}
kable(selectstats2,"latex", linesep = "", longtable = TRUE , booktabs = T, escape = F, digits = 3, caption = "Random Forest Model Performance", format.args = list(big.mark = ",")) %>% kable_styling(position = "center",font_size = 11, latex_options = c("hold_position", "repeat_header")) 

```

```{r predictions, include=FALSE, warning=FALSE, echo=FALSE, message=FALSE}
...
#writeOGR(obj=sp_jn1, dsn="C://School//Research//Predictive Variables//Master//FinalPredictions", layer="RF_PredictionProbsNH64", driver="ESRI Shapefile")
